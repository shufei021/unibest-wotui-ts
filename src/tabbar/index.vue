...
import { actColor, customTabbarEnable, needHideNativeTabbar, tabbarCacheEnable } from './config'
...
function getColorByIndex(index: number) {
  return actColor || (tabbarStore.curIdx === index ? activeColor : inactiveColor)
}
        ...
        >
          <view v-if="item.isBulge" class="relative">
            ...
            <view class="bulge">
              ...
              <image class="mt-6rpx h-200rpx w-200rpx" :src="getImageByIndex(index, item)" />
            </view>
          </view>
