...
export const nativeTabbarList: NativeTabBarItem[] = [
  ...
  },
  {
    ...
    selectedIconPath: 'static/tabbar/product-select.png',
    pagePath: 'pages/product/product',
    text: '商品',
  },
  {
    iconPath: 'static/tabbar/add.png',
    selectedIconPath: 'static/tabbar/add-select.png',
...
export const customTabbarList: CustomTabBarItem[] = [
  {
    ...
    iconActive: '/static/tabbar/home-select.png',
  },
  {
    text: '商品',
    pagePath: 'pages/product/product',
    iconType: 'image',
    icon: '/static/tabbar/product.png',
    iconActive: '/static/tabbar/product-select.png',
  },
  {
    pagePath: 'pages/category/category',
    text: '分类',
    ...
    iconActive: '/static/tabbar/add-select.png',
    // badge: 100,
    isBulge: true,
  },
  {
    ...
    iconActive: '/static/tabbar/message-select.png',
  },
  {
    pagePath: 'pages/me/me',
    text: '我的',
    ...
    iconActive: '/static/tabbar/mine-select.png',
  },
...
export const actColor: string | null = '#666'
